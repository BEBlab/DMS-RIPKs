...
# save this R file
save(silent, singles, singles_stops, file="nscore_df_hRIPK3.RData")

################################################################################
# Check how many variants are present in the input and in the output
variant_data_merge<-read_tsv("hRIPK3_variant_data_merge.tsv")
...
input_output_reads(5)
input_output_reads(10)
input_output_reads(100)
input_output_reads(120) # mininputcountall used in dimsum
