...
save(silent, singles, singles_stops, file="nscore_df_hRIPK3_tox.RData")

library("writexl")
write_xlsx(singles_stops, "hRIPK3_tox_singles.xlsx")
write_xlsx(silent, "hRIPK3_tox_synonymous.xlsx")

write.csv(singles_stops, "hRIPK3_tox_singles.csv", row.names=FALSE)
write.csv(silent, "hRIPK3_tox_synonymous.csv", row.names=FALSE)
